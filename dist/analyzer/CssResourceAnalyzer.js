...
exports.CssResourceAnalyzer = void 0;
class CssResourceAnalyzer {
    /**
    ...
    analyze(pageContent) {
        ...
        if (externalStylesheets.length > 0) {
            ...
            const thirdPartyStylesheets = externalStylesheets.filter(src => src.startsWith('http') && typeof window !== 'undefined'
...
exports.CssResourceAnalyzer = CssResourceAnalyzer;
